...
backupPath="spooncraft" #NO LEADING FORWARD-SLASH!
storePath="backup" #ServerName folder will be created in this folder. NO LEADING FORWARD-SLASH!
serverName="SpoonCraft"
screenName="testdrive"
...
sqlUser="spoon_inventorys" #MySQL Username
sqlPassword="3iof1Qib" #MySQL Password
sqlHost="localhost" #Keep the 'localhost' if the SQL Server is local
sqlDB="spoon_inventorys" #MySQL Database Name
